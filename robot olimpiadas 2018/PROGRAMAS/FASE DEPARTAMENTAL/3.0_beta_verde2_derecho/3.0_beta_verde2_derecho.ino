...
/*
color1();
if (verde1 < rojo1 && verde1 > azul1&&(verde1 >= 12&&verde1 <= 14)&&(((sensorValues[0]<=50)&&(sensorValues[7]<=50))&&(sensorValues[3]>=800)||(sensorValues[4]>=800)))  
  {  
   mover_robot(0,0,0,0);
   delay(2000);  
  ...
  */
color2();
if (verde2 < rojo2 && verde2 > azul2&&(verde2 ==13)&&(((sensorValues[0]<=50)&&(sensorValues[7]<=50))&&(sensorValues[3]>=800)||(sensorValues[4]>=800)))
  {  
   mover_robot(0,0,0,0);
   delay(2000);  
