...
float P=0, D=0, I=0;
float kp=0.094, kd=0.6, ki=0.01;           //0.005//0.008kp=0.013  kd=0,03 o  0,02 o 0,06 
int vel=70;//50//35
...
if((sensorValues[7]<=150)&&(sensorValues[6]<=150)&&(sensorValues[5]<=150)&&(sensorValues[3]>=800)&&(sensorValues[2]>=800)&&(sensorValues[1]>=800)&&(sensorValues[0]>=800))
{
  digitalWrite(13,HIGH);
  mover_robot(0,0,0,0);
  delay(1450);
  mover_robot(100,0,0,100);
  ...
  while(true)
  {
    ...
    qtra.read(sensorValues);
    if((sensorValues[0]==1000)&&(sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[7]==0))
    {
  digitalWrite(13,LOW);
      break;
    }
