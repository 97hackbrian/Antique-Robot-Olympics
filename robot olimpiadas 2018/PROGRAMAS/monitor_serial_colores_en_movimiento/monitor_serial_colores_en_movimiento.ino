...
float P=0, D=0, I=0;
float kp=0.05, kd=0.6, ki=0.020;           //kp=0.03
int vel=45;//50//35
...
Serial.print("R Intensidad:");  
  ...
  Serial.println(azul1, DEC);  

if (verde1 < rojo1 && verde1 > azul1&&(verde1 ==14)&&(((sensorValues[0]<=50)&&(sensorValues[7]<=50))&&(sensorValues[3]>=900)||(sensorValues[4]>=900)))
  {  
...
color2();
if (verde2 < rojo2 && verde2 > azul2&&(verde2 ==13)&&(((sensorValues[0]<=50)&&(sensorValues[7]<=50))&&(sensorValues[3]>=900)||(sensorValues[4]>=900)))
  {  
   mover_robot(90,0,0,50);
   delay(250);  
