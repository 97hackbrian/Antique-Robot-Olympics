...
qtrrc.read(sensorValues);
 position = qtrrc.readLine(sensorValues, QTR_EMITTERS_ON, 0);
  if((sensorValues[3]==1000||sensorValues[4]==1000)&&(sensorValues[0]<=20))
  {
    r++;
  digitalWrite(13,LOW);///ojo
    break;
  }
}
}
if ((sensorValues[0]==1000)&&(sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[3]==1000)&&(sensorValues[4]>=200)&&(sensorValues[6]<=150)&&(sensorValues[7]<=150)&&(r==7))
{
  //gira adelante
 analogWrite(pwma,100); // VELOCIDAD PARA EL MOTOR DERECHO
 analogWrite(pwmb,100); //  VELOCIDAD PARA EL MOTOR IZQUIERDO
...
if((sensorValues[0]>=500)&&(sensorValues[1]>=500)&&(sensorValues[2]>=500)&&(sensorValues[3]>=500)&&(sensorValues[4]>=500)&&(sensorValues[5]>=500)&&(sensorValues[6]>=500)&&(sensorValues[7]>=500)&&(r==8))
{
  r++;
  ///ultimo negro
  digitalWrite(ain1,HIGH);   ///FRENTE
...
qtrrc.read(sensorValues);
 ...
 if((sensorValues[0]<=150)&&(sensorValues[1]<=150)&&(sensorValues[2]<=150)&&(sensorValues[3]<=150)&&(sensorValues[4]<=150)&&(sensorValues[5]<=150)&&(sensorValues[6]<=150)&&(sensorValues[7]<=150)&&(r==7))
{
