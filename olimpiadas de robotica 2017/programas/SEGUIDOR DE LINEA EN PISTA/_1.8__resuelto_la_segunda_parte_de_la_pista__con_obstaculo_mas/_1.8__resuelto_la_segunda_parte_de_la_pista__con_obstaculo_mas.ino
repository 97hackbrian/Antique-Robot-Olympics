...
vel=(P*0.087)+(D*0.06)+(I*0.00470);// para velocidad 120//////estaba en 0.0925
...
if ((sensorValues[0]==1000)&&(sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[3]==1000)&&(sensorValues[4]==1000)&&(sensorValues[5]==1000)&&(sensorValues[6]<=250)&&(sensorValues[7]<=250))
{
  //gira a la izquierda
...
if ((sensorValues[0]==1000)&&(sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[3]==1000)&&(sensorValues[4]==1000)&&(sensorValues[5]==1000)&&(sensorValues[6]==1000)&&(sensorValues[7]<=250))
{
  //gira a la izquierda
 analogWrite(pwma,cruzero+vel+I); // VELOCIDAD PARA EL MOTOR DERECHO
  analogWrite(pwmb,cruzero-vel); //  VELOCIDAD PARA EL MOTOR IZQUIERDO
...
if((sharp1==5)||(sharp1==6)||(sharp1==7)||(sharp1==8)||(sharp1==9)||(sharp1==10)||(sharp1==11)||(sharp1==12)||(sharp1==13)||(sharp1==14))
{
     digitalWrite(ain1,LOW);   ///FRENTE
 digitalWrite(ain2,HIGH);
 ...
 digitalWrite(bin2,LOW);
 analogWrite(pwma,80); // VELOCIDAD PARA EL MOTOR DERECHO
 analogWrite(pwmb,29); //  VELOCIDAD PARA EL MOTOR IZQUIERDO
  delay(1900);
}
