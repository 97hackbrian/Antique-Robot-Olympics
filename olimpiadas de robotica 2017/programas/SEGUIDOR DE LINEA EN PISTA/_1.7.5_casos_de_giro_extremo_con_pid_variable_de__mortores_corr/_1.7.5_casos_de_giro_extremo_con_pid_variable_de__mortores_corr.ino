...
vel=(P*0.087)+(D*0.06)+(I*0.00460);// para velocidad 120//////estaba en 0.0925
...
if ((sensorValues[0]==1000)&&(sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[3]==1000)&&(sensorValues[6]<=250)&&(sensorValues[7]<=250))
{
 ...
 else if((sensorValues[0]<=200)&&(sensorValues[1]<=200)&&(sensorValues[2]<=200)&&(sensorValues[3]<=200)&&(sensorValues[4]<=200)&&(sensorValues[5]<=200)&&(sensorValues[6]<=200)&&(sensorValues[7]<=200))
{
 digitalWrite(ain1,HIGH);   ///FRENTE
 digitalWrite(ain2,LOW);
 digitalWrite(bin1,HIGH);  ///FRENTE
