...
if ((sensorValues[0]>=500)&&(sensorValues[1]>=500)&&(sensorValues[2]>=500)&&(sensorValues[3]>=500)&&(sensorValues[4]>=200)&&(sensorValues[6]<=20)&&(sensorValues[7]<=20)&&(r==1))
{
...
if((sensorValues[0]>=500)&&(sensorValues[1]>=500)&&(sensorValues[2]>=500)&&(sensorValues[3]>=500)&&(sensorValues[4]>=500)&&(sensorValues[5]>=500)&&(sensorValues[6]>=500)&&(sensorValues[7]>=500)&&(r==1))
{
  r++;
  ///ultimo negro
  digitalWrite(ain1,HIGH);   ///FRENTE
