...
digitalWrite(13,LOW);
 ...
 digitalWrite(bin1,HIGH);  ///FRENTE
 digitalWrite(bin2,LOW);
 analogWrite(pwma,66); // VELOCIDAD PARA EL MOTOR DERECHO
...
if((sensorValues[0]<=250)&&(sensorValues[1]<=250)&&(sensorValues[3]==1000)&&(sensorValues[4]==1000)&&(sensorValues[5]==1000)&&(sensorValues[6]==1000)&&(sensorValues[7]==1000))
{ 
  //gira a la derecha
 analogWrite(pwma,cruzero2+vel); // VELOCIDAD PARA EL MOTOR DERECHO
  analogWrite(pwmb,cruzero2-vel-I); //  VELOCIDAD PARA EL MOTOR IZQUIERDO
