...
vel=(P*0.055)+(D*0.01)+(I*0.01065);// para velocidad 120//////estaba en 0.0925
...
while((sensorValues[0]==1000)&&(sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[3]==1000)&&(sensorValues[6]<=250)&&(sensorValues[7]<=250))
...
break;
while ((sensorValues[0]<=250)&&(sensorValues[1]<=250)&&(sensorValues[4]==1000)&&(sensorValues[5]==1000)&&(sensorValues[6]==1000)&&(sensorValues[7]==1000))
{
