...
if (position>6990&&r==0)
{
 ...
 analogWrite(pwmb,190); //  VELOCIDAD PARA EL MOTOR DERECHO
...
if(position<10&&r==0)
{
 analogWrite(pwma,190); // VELOCIDAD PARA EL MOTOR IZQUIERDO
...
if((sensorValues[0]==1000)&&(sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[3]==1000)&&(sensorValues[4]==1000)&&(sensorValues[5]==1000)&&(sensorValues[6]==1000)&&(sensorValues[7]==1000)&&(r==0))
{
 ...
 digitalWrite(bin1,HIGH);  
 digitalWrite(bin2,LOW);
 analogWrite(pwma,190); // VELOCIDAD PARA EL MOTOR DERECHO
 analogWrite(pwmb,170); //  VELOCIDAD PARA EL MOTOR IZQUIERDO
  while(true) 
{
qtrrc.read(sensorValues);
...
if((sharp1==7||sharp1==8||sharp1==9||sharp1==10||sharp1==11||sharp1==12||sharp1==13&&z==1))
{
...
qtrrc.read(sensorValues);
 position = qtrrc.readLine(sensorValues, QTR_EMITTERS_ON, 0);
  if((sensorValues[4]==1000)||(sensorValues[3]==1000)&&(sensorValues[7]<=27))
  {
      z++;
    break;
  }
...
if((sensorValues[2]==1000)&&(sensorValues[3]==1000)&&(sensorValues[4]==1000)&&(sensorValues[5]==1000)&&(e==1))
{
...
if ((sensorValues[0]==1000)&&(sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[3]==1000)&&(sensorValues[4]>=200)&&(sensorValues[6]<=150)&&(sensorValues[7]<=150)&&(e==4))
{
    //digitalWrite(13,HIGH);  
  //gira adelante
...
if ((sensorValues[0]<=27)&&(sensorValues[1]<=27)&&(sensorValues[2]<=27)&&(sensorValues[3]<=27)&&(sensorValues[4]<=27)&&(sensorValues[5]<=27)&&(sensorValues[6]<=27)&&(sensorValues[7]<=27)&&(e==5))
{
    e++;
    delay(50);
    x++;
...
qtrrc.read(sensorValues);
     position = qtrrc.readLine(sensorValues, QTR_EMITTERS_ON, 0);
if ((sensorValues[0]<=27)&&(sensorValues[1]<=27)&&(sensorValues[2]<=27)&&(sensorValues[3]<=27)&&(sensorValues[4]<=27)&&(sensorValues[5]<=27)&&(sensorValues[6]<=27)&&(sensorValues[7]<=27)&&(c==0))
{
