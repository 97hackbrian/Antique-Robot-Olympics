...
{
 analogWrite(pwma,124); // VELOCIDAD PARA EL MOTOR IZQUIERDO
...
if(position<10&&r==0)
{
 analogWrite(pwma,144); // VELOCIDAD PARA EL MOTOR IZQUIERDO
...
if ((sensorValues[0]==1000)&&(sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[3]==1000)&&(sensorValues[4]==1000)&&(sensorValues[6]<=65)&&(sensorValues[7]<=65)&&(r==1))
{
  digitalWrite(13,HIGH);
  //gira adelante
 analogWrite(pwma,100); // VELOCIDAD PARA EL MOTOR DERECHO
...
if((sensorValues[0]<=75)&&(sensorValues[6]<=75)&&(sensorValues[7]==1000)&&(r==1))
{
...
if((sensorValues[7]<=75)&&(sensorValues[1]<=75)&&(sensorValues[0]==1000)&&(r==1))
{
