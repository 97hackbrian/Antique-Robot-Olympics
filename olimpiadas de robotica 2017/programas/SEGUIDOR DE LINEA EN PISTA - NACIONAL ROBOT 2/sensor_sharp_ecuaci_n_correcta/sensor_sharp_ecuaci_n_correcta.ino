...
int lectura2, cm2;
  ...
  Serial.print(cm3); // lectura del sensor 0 - 1 para ser mas precisos
  delay(1);
  ...
  cm4 = pow(3027.4 / lectura4, 1.260); // 497=5cm conversión a centímetros
  Serial.print("Sensor 4:  ");
  Serial.println(cm4); // lectura del sensor 0 - 1 para ser mas precisos
  delay(1);
  /*
