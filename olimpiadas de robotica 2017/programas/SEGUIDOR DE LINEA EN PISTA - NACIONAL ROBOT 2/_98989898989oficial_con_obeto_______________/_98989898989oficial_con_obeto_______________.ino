...
lectura3 = analogRead(ir_sharp3); // lectura del sensor 0
  sharp3 = pow(3027.4 / lectura1, 1.000)-1; // 497=5cm conversión a centímetros
  delayMicroseconds(1); // tiempo de espera 

if((sharp3==7||sharp3==8||sharp3==9||sharp3==10||sharp3==11||sharp3==12||sharp3==13&&z==1))
{
