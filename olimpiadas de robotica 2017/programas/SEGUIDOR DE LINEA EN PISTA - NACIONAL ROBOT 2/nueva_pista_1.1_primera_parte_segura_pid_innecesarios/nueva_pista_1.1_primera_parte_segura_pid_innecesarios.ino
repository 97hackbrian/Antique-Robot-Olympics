...
vel=(P*0.050)+(D*0.02)+(I*0.00400);// para velocidad 120//////estaba en 0.0925
...
if((sensorValues[0]<=10)&&(sensorValues[1]<=10)&&(sensorValues[4]==1000)&&(sensorValues[5]==1000)&&(sensorValues[6]==1000)&&(sensorValues[7]==1000))
{ while(true)
{
...
vel=(P*0.040)+(D*0.05)+(I*0.00300);// para velocidad 120//////estaba en 0.0925
...
///CRUZERO =VELOCIDAD PUNTA , V
 ...
 if((sensorValues[3]==1000||sensorValues[4]==1000)&&(sensorValues[7]<=10))
  {
    digitalWrite(13,LOW);
    break;
  }
...
if ((sensorValues[0]==1000)&&(sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[3]==1000)&&(sensorValues[6]<=10)&&(sensorValues[7]<=10))
{ while(true)
{
   int cruzero=90;
  qtrrc.read(sensorValues);
...
vel=(P*0.030)+(D*0.05)+(I*0.00300);// para velocidad 120//////estaba en 0.0925
...
if((sensorValues[4]==1000||sensorValues[3]==1000)&&(sensorValues[0]<=10))
  {
    break;
  }
}
...
vel=(P*0.060)+(D*0.05)+(I*0.00400);// para velocidad 120//////estaba en 0.0925
...
if ((sensorValues[0]==1000)&&(sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[6]<=30)&&(sensorValues[7]<=30))
{ while(true)
{
...
if((sensorValues[0]<=40)&&(sensorValues[1]<=40)&&(sensorValues[6]==1000)&&(sensorValues[7]==1000)&&(z==1))
{
  z++;
 while (true)
 {
