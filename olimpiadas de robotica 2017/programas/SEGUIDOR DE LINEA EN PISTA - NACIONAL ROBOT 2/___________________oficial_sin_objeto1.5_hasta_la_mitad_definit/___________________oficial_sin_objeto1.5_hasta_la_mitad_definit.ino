...
if((sensorValues[0]<=15)&&(sensorValues[1]<=15)&&(sensorValues[7]==1000)&&(z==1))
{
 analogWrite(pwma,140); // VELOCIDAD PARA EL MOTOR IZQUIERDO
 analogWrite(pwmb,140); //  VELOCIDAD PARA EL MOTOR DERECHO
 digitalWrite(ain1,HIGH);   ///RETROCEDE
...
*/
if((sensorValues[0]==1000)&&(sensorValues[6]<=15)&&(sensorValues[7]<=15)&&(z==1))
{
 analogWrite(pwma,140); // VELOCIDAD PARA EL MOTOR IZQUIERDO
 analogWrite(pwmb,140); //  VELOCIDAD PARA EL MOTOR DERECHO
 digitalWrite(ain1,LOW);   ///FRENTE
...
if((sensorValues[1]==1000)&&(sensorValues[2]==1000)&&(sensorValues[3]==1000)&&(sensorValues[4]==1000)&&(sensorValues[5]==1000)&&(sensorValues[6]==1000)&&(z==1))
{
 z++;
