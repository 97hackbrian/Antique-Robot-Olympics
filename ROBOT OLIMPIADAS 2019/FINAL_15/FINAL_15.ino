...
void loop() {
  ...
  if (analogRead(A0) >= 400 && analogRead(A1) >= 400 && analogRead(A2) >= 400 && analogRead(A3) >= 400 && analogRead(A4) >= 400 && analogRead(A5) >= 400 && analogRead(A6) >= 400 && analogRead(A7) >= 400 )
  {
    ...
    while (true)
    {
      motores(-24, -30);//38,44//33,39//30,36//    -27.-33
      leer_color();
  ...
  if (analogRead(A7) > 400 && analogRead(A6) > 400 && analogRead(A5) > 400 && analogRead(A4) > 400 && analogRead(A3) > 400 && analogRead(A1) < 150 && analogRead(A0) < 150)
  {
    motores(-43, 55);
    delay(335);
  }
