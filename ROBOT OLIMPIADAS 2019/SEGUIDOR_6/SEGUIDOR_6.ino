...
void loop() {
  ...
  if (analogRead(A0) >= 500 &&analogRead(A1) >= 500 && analogRead(A2) >= 500 && analogRead(A3) >= 500 && analogRead(A4) >= 500 && analogRead(A5) >= 500 && analogRead(A6) >= 500&&analogRead(A7) >= 500 )
  { motores(-9, -9);
  delay(60);
    motores(0, 0);
    delay(1000);
