...
a:
  if (analogRead(A0) >= 400 && analogRead(A1) >= 400 && analogRead(A2) >= 400 && analogRead(A3) >= 400 && analogRead(A4) >= 400 && analogRead(A5) >= 400 && analogRead(A6) >= 400 && analogRead(A7) >= 400 )
  {
    ...
    motores(-16, -16);//-23,-39//////////-24,-30
    digitalWrite(13, HIGH);

    while (true)
    {
      motores(-14, -16);//38,44//33,39//30,36//    -28.-30
      leer_color();
      if (suma1 >= 132 && suma1 <= 265 && suma2 >= 1130)
      {
        motores(0, 0);
        delay(100);
        motores(-40, 70);
      ...
      else if (suma2 >= 135 && suma2 <= 265 && suma1 >= 1130)
      {
        motores(0, 0);
        delay(100);
        motores(80, -40);
  ...
  if (analogRead(A7) > 785 && analogRead(A6) > 785 && analogRead(A5) > 785 && analogRead(A4) > 785 && analogRead(A3) > 785 && analogRead(A1) < 150 && analogRead(A0) < 150)
  {
    motores(-43, 55);
    delay(335);
  }

  if (analogRead(A0) > 785 && analogRead(A1) > 785 && analogRead(A2) > 785 && analogRead(A3) > 785 && analogRead(A4) > 785 && analogRead(A6) < 150 && analogRead(A7) < 150)
  {
    motores(55, -43);
    delay(305);
  }
