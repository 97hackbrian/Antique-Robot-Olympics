...
if(c==1)
  ...
  if (analogRead(A7) > 700 && analogRead(A6) > 700 && analogRead(A5) > 700 && analogRead(A4) > 700 && analogRead(A3) >700 && analogRead(A1) < 150 && analogRead(A0) < 150)
  {
    motores(-43, 55);
    delay(335);
  }

if (analogRead(A0) > 700 && analogRead(A1) > 700 && analogRead(A2) > 700 && analogRead(A3) > 700 && analogRead(A4) > 700 && analogRead(A6) < 150 && analogRead(A7) < 150)
  {
    motores(55, -43);
    delay(305);
  }
