...
void loop() {
  ...
  if (analogRead(A0) >= 400 && analogRead(A1) >= 400 && analogRead(A2) >= 400 && analogRead(A3) >= 400 && analogRead(A4) >= 400 && analogRead(A5) >= 400 && analogRead(A6) >= 400 && analogRead(A7) >= 400 )
  {
    ...
    motores(-28, -30);//-23,-39//////////-24,-30
    digitalWrite(13, HIGH);

    while (true)
    {
      motores(-24, -25);//38,44//33,39//30,36//    -28.-30
      leer_color();
      if (suma1 >= 162 && suma1 <= 225 && suma2 >= 1130)
      {
        motores(0, 0);
        delay(100);
        motores(-40, 70);
      ...
      else if (suma2 >= 165 && suma2 <= 225 && suma1 >= 1130)
      {
        motores(0, 0);
        delay(100);
        motores(80, -40);
...
/*
  while(c==7)
  {
    ...
    {
      motores(60,99);
      if(analogRead(A4)>500||analogRead(A5)>500)
      {
        motores(60,60);
        delay(200);
        break;
