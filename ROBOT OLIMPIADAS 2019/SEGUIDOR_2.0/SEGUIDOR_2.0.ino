...
float KP = 0.31; //0.25    0.55         1.81                    0.55              0.54
float KD = 2.86; //5.56    55             90      77              5.56           17.56
float Ki = 0.037; //0                 0.0008                   0.009v             0.008
...
qtra.readLine(sensorValues);
  ...
  if(sensorValues[1]>=450&&sensorValues[2]>=450&&sensorValues[3]>=450&&sensorValues[4]>=450&&sensorValues[5]>=450&&sensorValues[6]>=450)
{ motores(-10,-10);
