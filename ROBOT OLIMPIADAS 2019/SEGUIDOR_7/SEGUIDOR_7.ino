...
float Ki = 0; //0                 0.0037                   0.009v             0.008
...
void loop() {
  ...
  if (analogRead(A0) >= 400 && analogRead(A1) >= 500 && analogRead(A2) >= 500 && analogRead(A3) >= 500 && analogRead(A4) >= 500 && analogRead(A5) >= 500 && analogRead(A6) >= 500 && analogRead(A7) >= 400 )
  { motores(-10, -10);
    delay(60);
    motores(0, 0);
    delay(200);
  ...
  if(analogRead(A7)>500&&analogRead(A6)>500&&analogRead(A5)>500&&analogRead(A4)>500&&analogRead(A3)>500&&analogRead(A1)<150&&analogRead(A0)<150)
  {
      motores(-43,55);
      delay(335);
  }
